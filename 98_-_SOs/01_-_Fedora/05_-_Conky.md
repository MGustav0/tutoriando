...
Altere no arquivo de configuração `gedit /etc/conky/conky.conf`.
...
conky.text = [[
  ...
  ${offset +15}${voffset -20}${font Segoe UI:Bold:size=9}${color 294172}SYSTEM ${hr 2}$color${font}
  ${font ConkyColorsLogos:size=10}l${font}
  ${offset +15}${voffset -20}${font Segoe UI:size=9}Kernel${alignr}${kernel}
  --
  -- Performance
  ${color 127CC1}${font ConkyColors:size=10}l${font}
  ${offset +15}${voffset -20}${font Segoe UI:Bold:size=9}${color dodgerblue3}PERFORMANCE ${hr 2}$color${font}
  ...
  ${offset +15}${voffset -20}${font Segoe UI:size=9}Package ${cpu}% ${alignr}Freq: ${freq_g} GHz
  ${cpugraph 0 10,200 009afa ff0000 -t -l}
  --
  -- Processadores
  ${color 127CC1}${font ConkyColorsLogos:size=10}i${font}
  ${offset +15}${voffset -20}${color 127CC1}${font Segoe UI:bold:size=9}PROCESSORS ${hr 2}$color${font}
  ...
  -- Temperatura por core físico - Alterar de acordo com o seu processador
  -- O hwmon geralmente está localizado em: /sys/class/hwmon/
  -- hwmon1 = processador, hwmon2 = motherboard
  ...
  ${offset +15}${voffset -20}${font Segoe UI:Bold:size=9}${color black}MEMORY ${hr 2}$color${font}
  ${font Segoe UI:size=9}Use: ${memfree}/${memmax}${alignr}Free: ${memwithbuffers}
  ${memperc}%${memgraph 10,180 lightgray black -t -l}
  --
  -- GPU
  ${color 76b900}${font ConkyColorsLogos:size=10}n${font}
  ${offset +15}${voffset -20}${font Segoe UI:Bold:size=9}${color 76b900}GRAPHICS ${hr 2}$color${font}
  -- ${voffset 2}${font ConkyColorsLogos:size=12}n
  -- ${font Segoe UI:size=9}${exec nvidia-smi --query-gpu=name --format=csv,noheader} | ${exec (nvidia-smi --query-gpu=driver_version --format=csv,noheader)}
  ...
  -- Use o "cut" para cortar o resultado da expressão, como o do HDDTemp abaixo.
  ${font Font Awesome:size=10}
...
O Arquivo de personalização anterior está descontinuado, para consulta:
